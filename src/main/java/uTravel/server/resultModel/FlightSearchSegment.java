...
public class FlightSearchSegment extends MixSearchSegment  {
  ...
  public FlightSearchSegment(io.swagger.client.model.FlightSearchSegment f) {
	  departsAt = f.getDepartsAt();
	  arrivesAt = f.getArrivesAt();
	  origin = f.getOrigin();
	  destination = f.getDestination();
	  marketingAirline = f.getAircraft();
	  operatingAirline = f.getOperatingAirline();
	  flightNumber = f.getFlightNumber();
	  aircraft = f.getAircraft();
	  bookingInfo = f.getBookingInfo();
  }
  /**
